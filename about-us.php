...
<head>
    ...
    <title>About us | <?php echo _siteconfig('_sitetitle') ?></title>
            ...
            <div class="about__wrapper">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-7 col-md-8">
                        <div class="about__content" data-aos="fade-right" data-aos-duration="800" data-aos-delay="100">
                            ...
                            <div class="about__counter">
                                <div class="about__counter-item">
                                    <h3> <span class="purecounter" data-purecounter-start="200"
                                            data-purecounter-end="256" data-purecounter-once="false">256</span>+</h3>
                                    <p>Enrolled Learner</p>
                                </div>
                                <div class="about__counter-item">
                                    <h3><span class="purecounter" data-purecounter-start="0" data-purecounter-end="89"
                                            data-purecounter-once="false">89</span></h3>
                                    <p>Finished Session</p>
                                </div>
                                <div class="about__counter-item">
                                    <h3><span class="purecounter" data-purecounter-start="0" data-purecounter-end="99"
                                            data-purecounter-once="false">99</span>+</h3>
                                    <p>Satisfaction Rate</p>
                                </div>
                                <div class="about__counter-item">
                                    <h3><span class="purecounter" data-purecounter-start="0" data-purecounter-end="80"
                                            data-purecounter-once="false">80</span>+</h3>
                                    <p>Awards Winning</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="team__wrapper">
                <div class="row g-4">
                    <div class="col-md-6 col-sm-12">
                        <div class="team__header" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
    ...
    <section class="testimonial testimonial--style1 padding-top padding-bottom brand-1 mb-5" style="display: none;">
        <div class="container" data-aos="fade-up" data-aos-duration="800">
            ...
            <div class="testimonial__wrapper">
                ...
                <div thumbsSlider="" class="testimonial__author swiper mt-5">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
